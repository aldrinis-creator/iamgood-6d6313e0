  ...
  useEffect(() => {
    ...
    const channel = supabase
      ...
      .on("postgres_changes", {
        ...
        // Ignore pings initiated by User (only show pings sent by Guardian)
        if ((p.initiated_by || "guardian") !== "guardian") return;
        
        // Smart Context: If actively sitting on the Messages screen, DO NOT popup the bouncing bubble!
        if (currentPath.current.includes("message")) return;
