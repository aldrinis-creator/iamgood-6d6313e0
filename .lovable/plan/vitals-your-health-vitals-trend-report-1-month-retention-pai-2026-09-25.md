...
- The data deletion will take action on the 7th on the current month for the previous month with alerts starting from the last day of previous month, and 5th day and 7th day of current month. So no need to worry about data batching.
...
- Remove Document   
Analyzer, Symptom Checker, Medication Info and Tele-Consult from the Health Tools list. Their code stays in place; old links to them open the Health Tools list instead.
